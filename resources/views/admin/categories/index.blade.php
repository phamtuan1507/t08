        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('admin.categories.create') }}"
                    class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">Thêm danh mục</a>
                                    ...
                                    <td class="p-4">
                                        @if ($category->image)
                                            <img src="{{ asset('storage/' . $category->image) }}"
                                                alt="{{ $category->name }}" class="w-32 h-32 object-cover mt-2">
                                        @endif
                                    </td>
                                            ...
                                            <td class="p-4 pl-12">
                                                @if ($child->image)
                                                    <img src="{{ asset('storage/' . $child->image) }}"
                                                        alt="{{ $child->name }}" class="w-32 h-32 object-cover mt-2">
                                                @endif
                                            </td>
